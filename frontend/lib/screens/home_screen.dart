...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: const Text('GHADI'), actions: [IconButton(tooltip: 'Refresh', onPressed: _reload, icon: const Icon(Icons.refresh)), IconButton(tooltip: 'Sign out', onPressed: widget.onLogout, icon: const Icon(Icons.logout))]),
